  ...
  return (
    <div className="min-h-screen bg-bg text-text">
      <div className="mx-auto w-full max-w-4xl px-6 py-16 sm:px-10 sm:py-20 lg:px-12 lg:py-24">
        ...
        {/* HEADER */}
        <header className="mb-20 border-b border-line-strong pb-12">
          <p className="mb-5 text-xs font-medium uppercase tracking-[0.25em] text-text">
            SAUNUM.COM
          </p>
          ...
          <p className="mt-7 max-w-2xl text-base leading-7 text-text sm:text-lg">
        ...
        <section className="mb-20">
          <p className="mb-5 text-xs font-medium uppercase tracking-[0.22em] text-text">
            Põhiidee
          </p>
          ...
          <p className="mt-7 max-w-3xl text-base leading-7 text-text">
          ...
          <p className="mt-5 max-w-3xl text-base leading-7 text-text">
        ...
        >
          ...
          <div className="mt-8 space-y-3 border-y border-line-strong py-6 font-medium">
            <p>TOOTED</p>
            <p>MIKS SAUNUM?</p>
            <p>LEIA OMA SAUNUM</p>
            <p>TEADMISTEBAAS</p>
        ...
        {/* ROADMAP */}
        <section className="border-t border-line-strong pt-16 sm:pt-20">
          ...
          <div className="mt-10 divide-y divide-white/20 border-y border-line-strong">
        ...
        {/* CONCLUSION */}
        <section className="mt-20 border-t border-line-strong pt-16 sm:mt-24 sm:pt-20">
          <p className="text-xs font-medium uppercase tracking-[0.22em]">
            Kokkuvõte
          </p>
          ...
          <div className="mt-8 border-l border-line-strong pl-5 text-lg font-medium leading-8">
        ...
        {/* END */}
        <div className="mt-20 border-t border-line-strong pt-8 text-xs uppercase tracking-[0.18em]">
...
function BriefSection({
  ...
  return (
    <section className="border-t border-line-strong py-16 sm:py-20">
