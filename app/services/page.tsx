        ...
        >
          <div className="site-container py-24 md:py-32">
            <div className="max-w-4xl">
              <p className="mb-5 text-[10px] uppercase tracking-[0.28em] text-[#66645f]">
                Services
              </p>
          ...
          <div className="site-container py-24 md:py-32">
            ...
            <div className="border-t border-white/[0.09]">
              {services.map((service) => (
                <article
                  key={service.number}
                  className="border-b border-white/[0.09] py-12 md:py-16"
                >
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-[80px_0.8fr_1fr] md:gap-8">
                    ...
                    <div>
                      ...
                      <p className="mt-4 text-base leading-7 text-[#a7a39b]">
                        {service.intro}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="mt-7 grid grid-cols-1 gap-2 sm:grid-cols-2">
                        {service.points.map((point) => (
                          <li
                            key={point}
                            className="text-sm text-[#66645f]"
                          >
                            <span className="mr-2 text-[#a7a39b]">—</span>
                            {point}
                          </li>
                        ))}
                      </ul>
          ...
          <div className="site-container py-24 md:py-32">
            ...
            <div className="grid grid-cols-1 border-t border-white/[0.09] sm:grid-cols-2 lg:grid-cols-4">
              {process.map((step) => (
                <article
                  key={step.number}
                  className="border-b border-white/[0.09] py-8 sm:border-r sm:px-6 lg:min-h-[240px] lg:border-b-0 lg:px-8 first:lg:pl-0 last:lg:border-r-0"
                >
                  <div className="mb-8 text-xs text-[#66645f]">
                    {step.number}
                  </div>
          ...
          <div className="site-container py-24 md:py-32">
            <div className="grid grid-cols-1 gap-10 md:grid-cols-[0.35fr_1fr]">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-7 text-sm uppercase tracking-[0.22em] text-[#a7a39b]">
